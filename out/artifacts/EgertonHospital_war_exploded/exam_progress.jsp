...
<%
    ...
    try {
        ...
        <table class="table table-bordered table-hover table-striped">
            <tr><th>Lab Id</th><th>Name<th/><th>Patient Type</th><th>Reg. No.<th/><th>Staff Id</th><th>Nat. Id</th><th>Lab Exam<th/><th>Date sent<th/><th>Status<th/></tr>
        <%
        for(LabExams l:labExamsList){
            ...
            <a href="<%=response.encodeURL("/PatientLabView.jsp")%>"id="p_link">
                <tr id="<%=l.getId()%>"class="<%=l.getPatType()%>">
                    ...
                    <td><%=l.getNatId()%></td><td><%=l.getLab_exam()%><td/><td><%=l.getDate_sent()%></td><td><%=l.getStatus()%></td>
                </tr>
            </a>
            <%
        }
...
<script type="text/javascript">
    $(function(){
        ...
        $('tr').on('click',function () {
            ...
            //alert(id+" "+patType);
            window.open('<%=response.encodeURL("/PatientsLabView.jsp")%>?id='+id+'&fill_results=yes','_self');
        });
    });
</script>
<style>
