...
<nav class="navbar navbar-inverse fixed-top navbar-expand-lg navbar-dark bg-dark">
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
        <ul class="navbar-nav mr-auto">
            ...
            <li class="nav-item">
                <a class="nav-link" href="/new_record.jsp"><span class="glyphicon glyphicon-plus"></span>&nbsp;New Record</a>
            </li>
            <li class="nav-item">
        ...
        <div class="col-md-6 pull-right">
            <form action=""method="post"class="form-inline my-2 my-lg-0">
                <div class="input-group">
                    <input type="text" name="search_key" class="form-control  mr-sm-2" value="<%=session.getAttribute("search_key")%>" placeholder="Search for..."required>
