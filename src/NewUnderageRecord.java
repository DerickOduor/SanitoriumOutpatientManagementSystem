...
@WebServlet("/NewUnderageRecord")
public class NewUnderageRecord extends HttpServlet {
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try {
            ...
            if(visit_type.equalsIgnoreCase("First visit")&&patientType.equalsIgnoreCase("n_ch")){
                Date now=new Date();
                ...
                String qry="INSERT INTO patients(regno,name,dob,phone,relative,relative_phone,residence,home_address,d_o_a," +
                        ...
                        "'"+relative+"','"+relative_phone+"','-','"+home_address+"','"+dateFormat.format(now)+"','-','-','-','Underage','True','-','"+0+"')";
