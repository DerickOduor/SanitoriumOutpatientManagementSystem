...
@WebServlet("/NewAdultRecord")
public class NewAdultRecord extends HttpServlet {
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try {
            ...
            if(visit_type.equalsIgnoreCase("First visit")&&patientType.equalsIgnoreCase("n_ad")){
                Date now=new Date();
